...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        public static IEnumerable<Emp> Task1()
        {
            ...
            result = Emps.Where(emp => emp.Job.Equals("Backend programmer"));
            return result;
        }

        /// <summary>
        ///     SELECT  * FROM Emps Job = "Frontendprogrammer" AND Salary>1000 ORDER BY Ename DESC;
        /// </summary>
        public static IEnumerable<Emp> Task2()
        {
            IEnumerable<Emp> result = null;
            result = Emps.Where(emp => emp.Job.Trim().Contains("Frontendprogrammer") && emp.Salary > 1000)
        ...
        {
            IEnumerable<Emp> result = null;
            result = Emps.Where(emp => emp.Salary == Emps.Max(emp1 => emp1.Salary));
            return result;
        }
        ...
        {
            IEnumerable<object> result = null;
            result = Emps.Join(Depts, emp => emp.Deptno, dept => dept.Deptno,
        ...
        {
            IEnumerable<object> result = null;
            result = Emps.GroupBy(emp => emp.Job).Select(emp => new
            {
                Praca = emp.Key,
        ...
        {
            bool result = false;
            result = Emps.Any(emp => emp.Job.Equals("Backend programmer"));
            return result;
        }
        ...
        {
            Emp result = null;
            result = Emps.First(emp => emp.Job.Equals("Frontend programmer"));
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            ...
            result = Emps.GroupBy(e => e.Deptno)
                ...
                .Select(e => new
                {
                    name = Depts.Select(d => d.Dname).First(),
        ...
        {
            IEnumerable<Emp> result = null;
            result = CustomExtensionMethods.met12(Emps);
            return result;
        }
    ...
    {
        public static IEnumerable<Emp> met12(IEnumerable<Emp> Emps)
        {
